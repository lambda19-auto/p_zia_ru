    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-blue-50 text-blue-700 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-6">
                ...
                <span>ИИ-помощник нового поколения</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-8xl font-bold tracking-tighter leading-[1.1] lg:leading-[0.9] text-slate-900 mb-8 break-words">
                Путешествуйте <br className="hidden sm:block" />
                <span className="text-blue-600">разумно.</span>
              </h1>
              <p className="text-lg sm:text-xl text-slate-600 mb-10 max-w-lg leading-relaxed font-light">
                TravelAI использует передовые алгоритмы поиска и планирования, чтобы создать для вас маршрут мечты за считанные секунды.
              </p>
            ...
            >
              <div className="relative aspect-square md:aspect-video rounded-[2rem] overflow-hidden shadow-2xl border-8 border-white">
                ...
                <div className="absolute bottom-10 left-10 text-white">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest opacity-80 mb-1">Рекомендация ИИ</p>
                  <p className="text-2xl font-bold">Йосемити, США</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Лучшее время</p>
                  <p className="text-sm font-bold">Июнь — Август</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Экономия</p>
                  <p className="text-sm font-bold">До 30% бюджета</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold text-blue-600 uppercase tracking-[0.2em] mb-4">Возможности сервиса</h2>
            <p className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900">Почему выбирают TravelAI?</p>
          </div>
            ...
            {[
              {
                ...
                desc: "Мы сканируем тысячи сайтов за секунды, чтобы найти актуальные цены и предложения.",
                color: "blue"
              },
              {
                icon: <Wallet className="w-8 h-8" />,
                title: "Умное бюджетирование",
                desc: "Наш ИИ оптимизирует расходы, подсказывая, где можно сэкономить без потери комфорта.",
                color: "green"
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Персонализация",
                desc: "Учитываем количество детей, сезонные предпочтения и тип отдыха именно для вас.",
                color: "orange"
              }
            ].map((f, i) => (
              <motion.div
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 text-center">
          <div className="bg-slate-900 rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 md:p-20 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Готовы к приключениям?</h2>
              <p className="text-base sm:text-xl text-slate-400 mb-8 sm:mb-12 max-w-lg mx-auto font-light leading-relaxed">
                Присоединяйтесь к тысячам путешественников, которые уже планируют свои поездки с помощью ИИ.
              </p>
              <a 
                href={EXTERNAL_URL}
                target="_blank"
      ...
      <section id="how-it-works" className="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold text-blue-400 uppercase tracking-[0.3em] mb-4">Процесс</h2>
            <p className="text-4xl md:text-5xl font-bold tracking-tight">Как создается ваше приключение</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
            ...
            {[
              { num: "01", title: "Задайте направление", desc: "Укажите ваши пожелания, бюджет и количество путешественников на нашем сайте." },
              { num: "02", title: "Магия ИИ", desc: "Наша нейросеть анализирует доступные варианты и сопоставляет их с вашими критериями." },
              { num: "03", title: "Маршрут готов", desc: "Получайте структурированный план с ценами и полезными ссылками на источники." }
            ].map((step, i) => (
      ...
      <footer className="bg-slate-50 py-12 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-sm text-slate-500">
            © 2026 TravelAI. Все права защищены. lambda19.
          </p>
        </div>
      </footer>
    </div>
